...
public class InferenciaOWL2tesauro{
	...
	public static void main (String args[]) throws Exception{
		...
		model.write(new FileOutputStream(new File("librosColeccionInf.rdf")),"RDF/XML-ABBREV");
		colec.write(new FileOutputStream(new File("librosColeccion.rdf")),"RDF/XML-ABBREV");


		//mezclamos modelo y coleccion
		Model union = ModelFactory.createUnion(model, colec);
		union.write(new FileOutputStream(new File("librosUnion.rdf")),"RDF/XML-ABBREV");
